...
@section('content')
 ...
 <!-- RoomDetails -->
            <div id="RoomDetails" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active"><img src="{{url('images/photos/'.$room->image)}}" class="img-responsive" alt="slide"></div>
                <div class="item  height-full"><img src="{{url('images/photos/'.$room->image_2)}}"  class="img-responsive" alt="slide"></div>
                <div class="item  height-full"><img src="{{url('images/photos/'.$room->image_3)}}"  class="img-responsive" alt="slide"></div>
                </div>
                <!-- Controls -->
